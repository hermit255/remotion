...
const title = "20251230";
const newsSource = "https://news.yahoo.co.jp/articles/28a013786db316a68db36c189802f64d40a0b03ea";
const description = "「Gmail」にアドレス変更機能が順次追加か--公式文書で明らかに";
const youtubeTitle = "Gmailのアドレスが変更できるようになるらしい" + "【ずんだもん解説】";
